...
-------------------------------------------------
    Author: qinLess
    File: merge_dex.py
    Time: 2021/7/8 下午2:31
-------------------------------------------------
    Change Activity: 2021/7/8 下午2:31
-------------------------------------------------
    Desc: 
"""
import os
...
if __name__ == '__main__':
    args = {
        'dex_path': '/Users/admin/Desktop/android/file/wanwuxinxuan-dex',
        'apk_path': '/Users/admin/Desktop/android/file/wanwuxinxuan-6.4.3.apk',
        'output': '/Users/admin/Desktop/android/file/wanwuxinxuan-new-6.4.3.apk'
    }
